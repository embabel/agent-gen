...
class MetaAgent {
    ...
    /**
     * Generate Java package name from domain specification.
     * 
     * PURPOSE: Convert domain name to valid Java package naming convention.
     * 
     * Examples:
     * - "restaurant-booking" → "com.embabel.generated.restaurantbooking"
     * - "weather-services" → "com.embabel.generated.weatherservices"
     * 
     * FUTURE LLM ENHANCEMENT: Intelligent package structure decisions.
     * 
     * Example LLM prompt:
     * """
     * Generate appropriate Java package structure for this domain:
     * 
     * Domain: "${specification.domain}"
     ...
     * - Start with com.embabel.generated
     * - Consider logical sub-package organization
     * - Examples: com.embabel.generated.booking, com.embabel.generated.weather.forecast
     * """
     */
    private fun generatePackageName(specification: AgentSpecification): String {
        // Convert domain to valid package name (remove special chars, lowercase)
        val cleanDomain = specification.domain.lowercase()
